...
//                       <h5 className="chat-title">Staff</h5>
//                       <h5 className="chat-title">Riders</h5>
//                       <h5 className="chat-title">Drivers</h5>
//                     </div>
...
import { Scrollbar } from "react-scrollbars-custom";
import CommonFooter from "../../components/footer/commonFooter";
import { avatar14, avatar19, avatar20, user01, user49 } from "../../utils/imagepath";
...
const Chat = () => {
  ...
  // Chat Users Data
  const chatUsers = [
    { id: 1, name: "Anthony Lewis", role: "Staff", time: "02:40 PM", img: avatar14 },
    { id: 2, name: "Elliot Murray", role: "Riders", time: "06:12 AM", img: avatar19 },
    { id: 3, name: "Stephan Peralt", role: "Drivers", time: "03:15 AM", img: avatar20 },
    { id: 4, name: "Rebecca Smith", role: "Staff", time: "Sunday", img: user01 },
  ];
  ...
  const filteredUsers =
    activeTab === "All"
      ? chatUsers
      : chatUsers.filter((user) => user.role === activeTab);
      ...
      <div className="page-wrapper">
        <div className="content">
          <div className="chat-wrapper d-flex">
            ...
            {/* ================= LEFT SIDEBAR ================= */}
            <div className="sidebar-group p-3 border-end" style={{ width: "300px" }}>
              
              <h4 className="mb-3">Chats</h4>

              {/* Tabs */}
              <div className="d-flex gap-3 mb-3">
                {["All", "Staff", "Riders", "Drivers"].map((tab) => (
                  <h6
                    key={tab}
                    onClick={() => setActiveTab(tab)}
                    style={{ cursor: "pointer" }}
                    className={`mb-0 ${activeTab === tab ? "text-primary fw-bold" : ""}`}
                  >
                    {tab}
                  </h6>
                ))}
              ...
              <Scrollbar style={{ height: "75vh" }}>
                {filteredUsers.map((user) => (
                  <div
                    ...
                    style={{ cursor: "pointer", background: selectedUser?.id === user.id ? "#f1f1f1" : "" }}
                ...
                <>
                  ...
                  <div className="flex-grow-1 p-3" style={{ overflowY: "auto", background: "#f9f9f9" }}>
                    ...
                    <div className="mb-3 text-end">
                      <div className="d-inline-block bg-primary text-white p-2 rounded">
                        Hi, how are you?
                      </div>
                    </div>

                    <div className="mb-3">
                      <div className="d-inline-block bg-white p-2 rounded shadow-sm">
